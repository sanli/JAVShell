...
class Ui_MainDialog(object):
    ...
    def retranslateUi(self, MainDialog):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QtGui.QApplication.translate("MainDialog", "Tab 1", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.pushButton_2.setText(QtGui.QApplication.translate("MainDialog", "增加", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton.setText(QtGui.QApplication.translate("MainDialog", "删除", None, QtGui.QApplication.UnicodeUTF8))
        self.label_6.setText(QtGui.QApplication.translate("MainDialog", "抓拍路径", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_3.setText(QtGui.QApplication.translate("MainDialog", "...", None, QtGui.QApplication.UnicodeUTF8))
        self.label_7.setText(QtGui.QApplication.translate("MainDialog", "下载路径", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_4.setText(QtGui.QApplication.translate("MainDialog", "...", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), QtGui.QApplication.translate("MainDialog", "Tab 2", None, QtGui.QApplication.UnicodeUTF8))
